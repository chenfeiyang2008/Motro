...
function validItem(overrides: Partial<ItemSnapshot> = {}): ItemSnapshot {
  return {
    ...
    reviewDecisionType: null,
    reviewDraftStatus: null,
    reviewProvenanceComplete: false,
    reviewHandled: false,
    reviewConflicting: false,
    reviewSourceFactFetched: false,
    reviewSnapshotSpellingMatches: false,
    reviewNormalizedSpellingMatches: false,
    reviewSourceFactIdentityMatches: false,
    reviewCommitRowMatches: false,
    reviewRevisionPageConsistent: false,
    reviewSourceFactHashPresent: false,
    ...overrides,
  };
}
